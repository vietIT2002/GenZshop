...
?>
<div class="wrapper1">
        <div class="title1">Trợ lý AI hỗ mọi thắc mắc của bạn</div>
        <div class="form1">
            <div class="bot-inbox inbox">
                ...
                <div class="msg-header">
                    <p>Xin chào, tôi là trợ lý AI của GENZSHOP</p>
                </div>
            </div>
        </div>
            ...
            $("#send-btn").on("click", function(){
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        var botReply = '<div class="bot-inbox inbox"><div class="icon"><i class="fa-solid fa-robot"></i></div><div class="msg-header"><p>'+ result +'</p></div></div>';
